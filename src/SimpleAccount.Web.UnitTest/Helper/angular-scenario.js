...
if ( document.documentElement.compareDocumentPosition ) {
	...
	sortOrder = function( a, b ) {
		...
		// to buildtools up a full list of the parentNodes for comparison
		while ( cur ) {
			ap.unshift( cur );
			cur = cur.parentNode;
		}
...
jQuery.fn.extend({
	load: function( url, params, callback ) {
		...
		if ( params ) {
			...
			// Otherwise, buildtools a param string
    ...
    link: function(scope, element, attr, ctrls) {
      ...
      function Options(scope, selectElement, ctrl) {
        ...
        function render() {
          ...
          // We now buildtools up the list of options we need (we merge later)
